...
export function ProductPage() {
    ...
    return (_jsxs("article", { className: "grid gap-8 rounded-3xl border border-slate-800 bg-slate-900/60 p-6 md:grid-cols-2", children: [_jsx("div", { className: "flex items-center justify-center self-start overflow-hidden rounded-3xl bg-slate-950", children: _jsx("img", { src: product.image, alt: product.title, className: "h-auto w-full max-w-full object-contain" }) }), _jsxs("div", { className: "flex flex-col gap-6", children: [_jsxs("div", { className: "flex flex-col gap-3", children: [_jsx(Link, { to: "/", className: "text-sm text-brand", children: "\u2190 Back to catalog" }), _jsx("h1", { className: "text-3xl font-bold text-slate-100", children: product.title }), _jsx(Badge, { color: stockColor, children: stockLabel }), _jsx("p", { className: "text-lg text-slate-300", children: product.description }), _jsx("p", { className: "text-4xl font-semibold text-slate-50", children: formatCurrency(product.price) })] }), _jsxs("div", { className: "flex flex-col gap-3 sm:flex-row", children: [_jsx(Button, { size: "lg", onClick: () => {
