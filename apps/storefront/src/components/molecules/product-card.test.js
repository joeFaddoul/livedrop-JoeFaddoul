...
describe('ProductCard', () => {
    it('renders product info', () => {
        render(_jsx(MemoryRouter, { children: _jsx(ProductCard, { product: product, onAddToCart: () => { } }) }));
    ...
    it('fires add to cart handler', async () => {
        ...
        const onAdd = vi.fn();
        render(_jsx(MemoryRouter, { children: _jsx(ProductCard, { product: product, onAddToCart: onAdd }) }));
